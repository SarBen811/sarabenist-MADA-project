...
readRDS(file = here("results", "model fit tables", "incfittableFD.rds")) 
```
...
readRDS(file = here("results", "model fit tables", "mortfittable.rds"))
```
```{r}
#| label: tbl-mortfit
#| fig-cap: "Summary table for fitted linear model predicting mortality"
readRDS(file = here("results", "model fit tables", "mortfittableFD.rds"))
```
...
readRDS(file = here("results", "model fit tables", "prevfittable.rds"))
```
```{r}
#| label: tbl-prevfit
#| fig-cap: "Summary table for fitted linear model predicting prevalence"
readRDS(file = here("results", "model fit tables", "prevfittableFD.rds")) 
```
