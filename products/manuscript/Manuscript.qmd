...
After processing the data, the `otherburden` and `highburden` datasets were described by exploring each health equity indicators and tuberculosis outcome. The table below shows the list of indicators, and the codebook can be found in the README.md file.
